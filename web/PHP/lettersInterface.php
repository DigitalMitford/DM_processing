...
<div id="container">
    ...
    <div id="content">
        ...
        <p>This interface represents our encoding so far of a selection of letters held in the Reading Central Library and the John Rylands Library from the years 1819-1825, years that the Mitford team has identified as pivotal in the shaping of Mitford’s literary career as she began developing her plays and short fiction. The editions displayed here are <em>active work in progress</em>, in a reasonably complete form suitable for reading but possibly requiring corrections or additional work. As we add newly coded letters and file corrections to our database, the list of available material and the editions of letters will update here. Please select a year to view the available letters.</p>
        <ul>
<?php
