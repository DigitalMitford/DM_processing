...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <!--ebb: Stylesheet designed to sit in an eXist environment to respond to PHP calls from the digitalmitford.org website and transform XML files in the eXist-db. -->  
