...
let $people := $mitfordColl//text//p//persName/@ref/string()
...
let $fileMatch := $mitfordColl[.//text//p//persName/@ref[substring-after(string(), '#') = $n1]]    
for $f in $fileMatch
...
let $otherPeople := $f//text//p//persName[not(contains(@ref, $n1))]/@ref/string()
